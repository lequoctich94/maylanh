                                        ...
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                <div>
                                                    ...
                                                    <div class="user-last-chat">Respect yourself if you would have
                                                        others respect you.</div>
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0);" class="media read-chat">
                                            ...
                                            <div class="media-body">
                                                <div>
                                                    ...
                                                    <div class="user-last-chat">staff was calling me to make sure I was
                                                        there</div>
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0);" class="media read-chat">
                                            ...
                                            <div class="media-body">
                                                <div>
                                                    ...
                                                    <div class="user-last-chat">Concentrate on studdies will be the text
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <a href="javascript:void(0);" class="media read-chat">
                                            ...
                                            <div class="media-body">
                                                <div>
                                                    ...
                                                    <div class="user-last-chat">Good morning! I am here to talk to you
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="media received">
                                                ...
                                                <div class="media-body">
                                                    <div class="msg-box">
                                                        <div>
                                                            <p>Hey Ben, just a reminder that you are coming for the
                                                                meeting today in the conference. We are proposing a
                                                                change in the client briefing.</p>
                                            ...
                                            <li class="media sent">
                                                <div class="media-body">
                                                    <div class="msg-box">
                                                        <div>
                                                            <p>Sure, on my way to office. Please give me quick update.
                                                            </p>
                                            ...
                                            <li class="media sent">
                                                <div class="media-body">
                                                    <div class="msg-box">
                                                        <div>
                                                            <p>Haha, this joke is hilarious. Is it what your heart feel
                                                                about the salary?</p>
                                                    ...
                                                    <div class="msg-box">
                                                        <div>
                                                            <p>Anyways, I am working on something that you would like to
                                                                know. This project is based on angular js and you are
                                                                the keeda in it. I need you help in it.</p>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn  btn-light  dropdown-toggle no-caret"
                                                data-toggle="dropdown"><span class="feather-icon"><i
...
<!-- Mirrored from hencework.com/theme/pangong/chats.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Oct 2021 23:51:46 GMT -->
