appMain.controller(
  ...
  function (
    ...
    $scope.initRegisterController = function () {
      ...
      accountService.getProvinces(
        $scope.getProvincesCompleted,
        $scope.getError
      );
    };
    $scope.initPersonalController = function () {
      ...
      accountService.getProvinces(
        $scope.getProvinceUpdateCompleted,
        $scope.getError
      );
    ...
    $scope.getDistricts = function (provinceId) {
      ...
      accountService.getDistricts(
        obj,
        $scope.getDistrictsCompleted,
        $scope.getError
      );
    };
    ...
    $scope.getDistrictUpdate = function (provinceId) {
      ...
      accountService.getDistricts(
        obj,
        $scope.getDistrictUpdateCompleted,
        $scope.getError
      );
    };
    ...
    $scope.forgetPassword = function (response) {
      ...
      accountService.forgetPassword(
        obj,
        $scope.forgetPasswordCompleted,
